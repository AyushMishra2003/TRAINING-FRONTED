...
const features = [
  {
    icon: <FaChalkboardTeacher size={24} className="text-green-500" />,
    title: "Expedite Learning",
    description: "Adopting fast learning techniques by real-world experts",
  },
  {
    icon: <FaLaptopCode size={24} className="text-green-500" />,
        ...
        <div className="flex flex-wrap justify-around items-start">
          {features.map((feature, index) => (
            <div key={index} className="w-full sm:w-1/2 lg:w-1/3 p-4 cursor-pointer">
              <div className="bg-white shadow-lg rounded-lg p-6 h-full hover:shadow-xl transition duration-300 ease-in-out transform hover:-translate-y-1">
                <div className="mb-4">
                  {feature.icon}
                </div>
