...
const HeroSection = () => {
  return (
    <section className="flex flex-col-reverse lg:flex-row items-center justify-center  bg-[#F0F4F9]  lg:gap-[15rem] gap-4">
      {/* Left Section */}
      <div className="flex flex-col lg:w-[30rem]  lg:items-start gap-4 md:gap-2 items-center">
        ...
        <div className="flex gap-4 flex-col sm:flex-row">
          ...
          <button className="bg-white text-black border border-[#424141]  font-bold px-10 py-4 rounded hover:bg-yellow-500 duration-500">
            Read More
          </button>
        </div>
      </div>
